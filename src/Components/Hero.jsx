  ...
  return (
    <div className="grid md:grid-cols-2 justify-between z-[-20]">
      <img
        src={"profile3.png"}
        alt=""
        className="grayscale animate__animated animate__fadeInLeft"
      />
      <div className="flex flex-col justify-center md:gap-3 gap-1 lg:gap-6 md:px-10 px-6 lg:px-20 animate__animated animate__fadeInRight">
